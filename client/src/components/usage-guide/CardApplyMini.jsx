...
const BENEFITS = [
    { bg: colors.warmBg, dot: colors.store.category.food, mark: 'W', text: <span>충전 즉시 <b>10%</b> 할인<br /><span style={{ fontSize: sizes.xxs, color: colors.gray[500] }}>월 <b>최대 3만원</b> 할인</span></span> },
